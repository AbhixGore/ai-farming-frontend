      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
          ...
          <button onClick={() => onSave(form)} style={{
            ...
            border: "none", background: "linear-gradient(135deg, #1b5e20, #2e7d32)",
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
          <button onClick={() => setFarmerProfile(null)} title="माहिती बदला" style={{
            ...
            color: "white", padding: "5px 9px", borderRadius: 16,
          ...
          {speaking && (
            <button onClick={stopSpeaking} style={{
              ...
              color: "white", padding: "5px 10px", borderRadius: 16,
      ...
      <div style={{
        ...
        <input
          ...
          style={{
            ...
            border: "1.5px solid #c8e6c9", fontSize: 14,
            outline: "none", background: loading ? "#f9f9f9" : "white",
        ...
        <button
          ...
          style={{
            ...
            fontSize: 20, cursor: loading || !message.trim() ? "not-allowed" : "pointer",
            display: "flex", alignItems: "center", justifyContent: "center",
            flexShrink: 0
          }}
        >
